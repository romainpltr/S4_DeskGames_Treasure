...
$(document).ready(function(){
    ...
    if (letour==0) {
        ...
        $('#pirate1,#pirate2,#pirate3,#pirate4,#pirate5,#pirate6,#pirate7').css({'transform':'rotateY(180deg)'});
        $('.main_user').css({'visibility':'visible', 'top':'79%','left':'28%'});
        $('.hand').css('margin','0.5%');
    ...
    function distribution(){
        ...
        $('.main_user').animate({'top':'79%','left':'27%'});
        setTimeout(function(){
            $('.hand').css({'margin':'0.5%'});
        },300);
        $('.act_click').bind('click',function(){
    ...
    // retourner les cartes pirate
    function rotate(){
        $('#pirate1').css({'transform':'rotateY(0deg)','transition-delay':'1s'});
        $('#pirate2').css({'transform':'rotateY(0deg)','transition-delay':'1.1s'});
        $('#pirate3').css({'transform':'rotateY(0deg)','transition-delay':'1.2s'});
        $('#pirate4').css({'transform':'rotateY(0deg)','transition-delay':'1.3s'});
        $('#pirate5').css({'transform':'rotateY(0deg)','transition-delay':'1.4s'});
        $('#pirate6').css({'transform':'rotateY(0deg)','transition-delay':'1.5s'});
        $('#pirate7').css({'transform':'rotateY(0deg)','transition-delay':'1.6s'});
        distribution();
    }
